...
## Ideia 💡:
Criar um projeto para gerar paletas de cores aleatórias.

## Projeto de referência 🤝:
[<ins>Link do site **Coolors**</ins>](https://coolors.co/).
...
[<ins>Link do projeto</ins>](https://caioliveira277.github.io/color-palette/)
